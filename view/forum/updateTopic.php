...
<div class="container-category">
  ...
  <div class="banner">
    ...
    <?php } else { ?>
      <p class="message-connection"> Pour modifier un sujet veuillez vous connecter<a href="index.php?ctrl=security&action=loginForm"> <i class="fa-solid fa-share"></i></a></p>
    <?php } ?>
