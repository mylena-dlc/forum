...
<div class="container-category">
  ...
  ?>
          ...
          <h3 class="title-add">Ajouter un sujet</h3>
            ...
            <input type="text" name="title" placeholder="Saisir le nom du sujet">
    ...
    <?php } else { ?>
           <p class="message-connection"> Pour créer un topic veuillez vous connecter<a href="./view/security/login.php"> <i class="fa-solid fa-share"></i></a></p>
    <?php } ?>
  ...
  <div class="grid">
      ...
      ?>
        ...
        <div class="card">
          <h5 class="card-title">
          <a href="index.php?ctrl=forum&action=listPostsByIdTopic&id=<?= $topic->getId() ?>"> <?=$topic->getTitle()?> </a>
          ...
          <div class="action">
            ...
            <!-- lock un sujet -->
            <!-- Utilisation de la ternaire pour afficher le cadenas fermé ou ouvert -->
            <button class="btn-update">
    ...
    <?php } ?>
        ...
        ?>
      <!-- // } else {
      //     echo "<h4 class='title-h4'> Aucun topic </h4>";
      //   }  -->
  </div>
</div>